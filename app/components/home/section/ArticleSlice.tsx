...
import { ArticleSlice as Slice, CollectionBlock } from '../global-types';
...
const sliceBlockBuilder = (slice: Slice, collection: CollectionBlock, isIndexPage?: boolean) => {
  ...
  const sliceTypes = {
    ...
    SECONDARY_4: <SectionRow slice={slice} collection={collection} sectionURL={sectionURL} showTitle={!isIndexPage} />,
    SECONDARY_4_ODD: (
      <SectionRow
        slice={slice}
        ...
        titleBarColour={(true && `${getColorCssFromTheme('color', 'transparent')}`) as string}
