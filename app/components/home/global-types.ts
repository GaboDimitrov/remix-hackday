...
export type SliceBlock = ArticleBlock | VideoBrightcoveBlock | ExternalReferenceBlock;
...
export type PageBlock = CollectionBlock | ImageBlock | TweetBlock | ParagraphBlock;
